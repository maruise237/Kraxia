...
export async function getMe(): Promise<AuthUtilisateur> {
  return fetchJSON<AuthUtilisateur>('/api/auth/me')
}
...
export async function listCompétences(): Promise<Skill[]> {
...
// ---------------------------------------------------------------------------
// Compétences marketplace (skills.sh)
// ---------------------------------------------------------------------------
...
export async function searchCompétences(
  query: string,
  limit = 10,
...
export async function scanGitCompétences(url: string): Promise<GitScanResult> {
...
export async function installGitCompétences(
  cacheKey: string,
  skillNames: string[],
...
export async function getRecommendedCompétences(): Promise<{ categories: RecommendedCategory[] }> {
